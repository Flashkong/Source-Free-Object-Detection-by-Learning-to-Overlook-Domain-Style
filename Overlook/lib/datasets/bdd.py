...
class bdd(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'bdd_2007_' + image_set)
        self._year = 2007
        ...
        self._classes = ('__background__',  # always index 0
                         'person', 'rider', 'car', 'truck', 'bus', 'motorcycle', 'bicycle')  # deleted train
        self._class_to_ind = dict(zip(self.classes, xrange(self.num_classes)))
        self._image_ext = '.jpg'
        self._image_index = self._load_image_set_index()

        self._image_names = self.get_image_names()
    ...
    def get_image_names(self):
        self.imgname_list = os.path.join(self._data_path, "ImageSets/Main", self._image_set + '.txt')
        with open(self.imgname_list, 'r') as f:
            lines = f.readlines()
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', 'bddk', 'Main')
