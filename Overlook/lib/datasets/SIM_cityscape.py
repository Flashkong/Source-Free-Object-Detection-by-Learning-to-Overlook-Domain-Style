...
class SIM_cityscape(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'SIM_cityscape' + year + '_' + image_set)
        self._year = year
        ...
        #                  'truck', 'bus', 'train',
        #                  'motorbike', 'bicycle')
        # self._classes = ('__background__', 'person', 'motorbike', 'car',)
        # self._classes = ('__background__',  # always index 0
    ...
    def _load_image_set_index(self):
        ...
        if os.path.exists(image_set_file):
            ...
            img_path = os.path.join(self._data_path, 'JPEGImages')
            for root, dirs, files in os.walk(img_path):
                for file in files:
                    image_index.append(os.path.splitext(file)[0])
            # with open(image_set_file, 'wb') as f:
            #     f.write(image_index)
            #     f.close()
            #pdb.set_trace()
        return image_index
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'SIM')
