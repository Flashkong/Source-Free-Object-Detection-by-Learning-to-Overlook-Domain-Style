...
class _fasterRCNN(nn.Module):
    ...
    def __init__(self, classes, class_agnostic, args=None,imdb=None):
        ...
        if args != None:
            if args.net == 'vgg16':
                self.adain = enhance_vgg16(args,imdb)
            elif args.net == 'res101':
                self.adain = enhance_vgg16(args,imdb)

    def forward(self, im_data, im_info, gt_boxes, num_boxes,
                rois_t=None, student=False, target=False,eta=1.0):
        ...
        if target:
            return rois, cls_score,pooled_feat,base_feat
